...
with st.sidebar.expander("📊 Company Base Data (FY2025, consolidated)", expanded=False):
    st.caption("All values in ₹ crore unless otherwise noted. Editable if you want to override.")
...
with st.sidebar.expander("⚙️ Line-item Margins (defaults from FY2025)", expanded=False):
    st.caption("Expressed as % of revenue, editable to test different scenarios.")
...
st.caption("Source: Infosys Consolidated FY2024–25 Annual Report (₹ crore). All figures truth-based, no assumptions beyond reported line-items.")
